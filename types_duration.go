...
func AsDuration(d time.Duration) *Duration { return (*Duration)(ptr(d)) }
...
func Hours(h int64) *Hour { return (*Hour)(ptr(h)) }
...
func Minutes(h int64) *Minute { return (*Minute)(ptr(h)) }
...
func Seconds(s int64) *Second { return (*Second)(ptr(s)) }
...
func Milliseconds(s int64) *Millisecond { return (*Millisecond)(ptr(s)) }
...
func Microseconds(v int64) *Microsecond { return (*Microsecond)(ptr(v)) }
...
func Nanoseconds(v int64) *Nanosecond { return (*Nanosecond)(ptr(v)) }
